...
import Progress_bar from "../containers/Progressbar";
...
import DayMealPage from "./DayMealPage";
...
const UserDashboardPage = ({
  ...
  const [currentPage, setCurrentPage] = useState("home"); // State to keep track of current page
  ...
  // Render the current page based on the value of currentPage state
  const renderPage = () => {
    switch (currentPage) {
      case "home":
        return (
                  ...
                  <div className="col-8">
                    ...
                    <div className="col-6">
                      <div className="card-black mb-3 px-2 py-3">
                        <h5 className="card-black card-header border-0 ">
                          One day meal price
                        </h5>
                        <div className="px-4">
                          {meal ? (
                            ...
                            <form onSubmit={handleFormSubmit}>
                              <input
                                ...
                                value={mealPrice}
                                onChange={(e) =>
                                  setMealPrice(parseFloat(e.target.value))
                                }
                              />
                              <button className="btn-meal" type="submit">
                                Update
                              </button>
                            </form>
                          ) : (
                ...
                mealDonation.map((donation) => (
                  <div className="card" key={donation.id}>
                    ...
                    <p className="card-text">
                      Date: {donation.date_of_booking}
                    </p>
                    <button
                      onClick={() => handleJoinRoom(donation.donator.email)}
                      className="btn-meal"
                    >
                      Go Live
                    </button>
    ...
    <div className="container-fluid">
      <div className="row">
        <div className="col-sm-2 sidebar">
          {/* Sidebar with four icons */}
          <ul className="list-unstyled">
            <li>
              <a href="#home" onClick={() => handleSidebarItemClick("home")}>
                <FaHome /> Home
              </a>
            </li>
            <li>
              <a
                href="#day-meal"
                onClick={() => handleSidebarItemClick("day-meal")}
              >
                <FaUtensils /> Day Meal
              </a>
            </li>
            ...
            <li>
              <a href="#needs" onClick={() => handleSidebarItemClick("needs")}>
                <FaList /> Needs
              </a>
            </li>
          </ul>
